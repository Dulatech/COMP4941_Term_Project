...
namespace COMP4941_Term_Project.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Address,ParentBranchID")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Address,ParentBranchID")] Branch branch)
        {
            if (ModelState.IsValid)
            {
